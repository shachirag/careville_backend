...
type AppointmentEntity struct {
	...
	FitnessCenter        *FitnessCenterAppointmentEntity       `json:"fitnessCenter" bson:"fitnessCenter,omitempty"`
	Hospital             *HospitalAppointmentEntity            `json:"hospital" bson:"hospital,omitempty"`
