...
type GetMedicalLabScientistDetailResDto struct {
	Status  bool                            `json:"status" bson:"status"`
	Message string                          `json:"message" bson:"message"`
	Data    GetMedicalLabScientistDetailRes `json:"data" bson:"data"`
}

type GetMedicalLabScientistDetailRes struct {
	Id                             primitive.ObjectID             `json:"id" bson:"id"`
	ProfileId                      string                         `json:"profileId" bson:"profileId"`
	FacilityOrProfession           string                         `json:"facilityOrProfession" bson:"facilityOrProfession"`
	Role                           string                         `json:"role" bson:"role"`
	User                           User                           `json:"user" bson:"user"`
	MedicalLabScientistInformation MedicalLabScientistInformation `json:"information" bson:"information"`
