...
// 		"doctor.professionalDetails.speciality":      1,
// 		"doctor.professionalDetails.qualifications":  1,
...
// 	var serviceData []doctorProfession.Schedule
// 	if service.Doctor != nil && len(service.Doctor.Schedule.Slots) > 0 {
// 		for _, service := range service.Doctor.Schedule.Slots {
...
// 				})
// 			}
// 			serviceData = append(serviceData, doctorProfession.Schedule{
// 				Slots: scheduleData,
// 			})
// 		}
// 	}
