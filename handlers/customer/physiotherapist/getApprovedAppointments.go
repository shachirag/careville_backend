...
// @Router /customer/healthProfessional/appointment/physiotherapist-approved-appointments [get]
func FetchApprovedPhysiotherapistAppointmentsWithPagination(c *fiber.Ctx) error {
