...
// @Router /customer/healthProfessional/appointment/medicalLabScientist-appointments [get]
func FetchMedicalLabScientistAppointmentsWithPagination(c *fiber.Ctx) error {
