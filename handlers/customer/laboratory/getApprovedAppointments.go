...
// @Router /customer/healthFacility/appointment/laboratory-approved-appointments [get]
func FetchApprovedLaboratoryAppointmentsWithPagination(c *fiber.Ctx) error {
