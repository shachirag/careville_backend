...
import (
	...
	hospitals "careville_backend/dto/provider/services"
...
// @Router /provider/services/appointment/hospital-approved-appointments [get]
func FetchHospitalApprovedAppointmentsWithPagination(c *fiber.Ctx) error {
	...
	for cursor.Next(ctx) {
		...
		if appointment.HospitalClinic != nil {
			fromDate = appointment.HospitalClinic.AppointmentDetails.From
