...
// @Router /provider/services/delete-medicalLabScientist-service/{serviceId} [delete]
func DeleteMedicalLabScientistService(c *fiber.Ctx) error {
	ctx := context.TODO()
	...
	update := bson.M{
		"$pull": bson.M{
			"medicalLabScientist.serviceAndSchedule": bson.M{"id": serviceObjID},
		},
	}
