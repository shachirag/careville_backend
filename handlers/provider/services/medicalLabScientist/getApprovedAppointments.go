...
// @Router /customer/services/appointment/medicalLabScientist-approvedappointments [get]
func FetchMedicalLabScientistApprovedAppointmentsWithPagination(c *fiber.Ctx) error {
