...
import (
	...
	nurse "careville_backend/dto/provider/services"
...
// @Router /provider/services/appointment/nurse-approved-appointments [get]
func FetchNurseApprovedAppointmentsWithPagination(c *fiber.Ctx) error {
