...
import (
	...
	fitnessCenter "careville_backend/dto/provider/services"
...
// @Router /customer/services/appointment/fitnessCenter-approved-appointments [get]
func FetchFitnessCenterApprovedAppointmentsWithPagination(c *fiber.Ctx) error {
