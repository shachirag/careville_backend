...
import (
	...
	laboratory "careville_backend/dto/provider/services"
...
// @Router /provider/services/appointment/laboratory-approved-appointments [get]
func FetchLaboratoryApprovedAppointmentsWithPagination(c *fiber.Ctx) error {
