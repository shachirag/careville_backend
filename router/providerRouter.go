...
func ProviderSetupsRoutes(app *fiber.App) {
	...
	appointmentServices.Get("/doctor-appointment/:id", doctorProfession.GetDoctorprofessionAppointmentByID)
	...
	appointmentServices.Get("/medicalLabScientist-appointment/:id", medicalLabScientist.GetMedicalLabScientistAppointmentByID)
	...
	appointmentServices.Get("/nurse-appointment/:id", nurse.GetNurseAppointmentByID)
