...
func CustomerSetupsRoutes(app *fiber.App) {
	...
	app.Static("/", ".puplic")
	app.Post("/send-appointment-reminder", schedular.SendAppointmentReminderNotification)
	...
	healthFacility.Post("/add-pharmacy-review", pharmacy.AddPharmacyReview)
	healthFacility.Post("/add-fitnessCenter-review", fitnessCenter.AddFitnessCenterReview)
	...
	healthProfessional.Post("/add-doctor-review", doctorProfession.AddDoctorReview)
	healthProfessional.Post("/add-nurse-review", nurse.AddNurseReview)
	healthProfessional.Post("/add-medicalLabScientist-review", medicalLabScientist.AddMedicalLabScientistReview)
	healthProfessional.Post("/add-physiotherapist-review", physiotherapist.AddPhysiotherapistReview)
	...
	appointments.Get("/pharmacy-drug/:id", pharmacy.GetPharmacyAppointmentByID)
	...
	appointment.Get("/doctor-appointment/:id", doctorProfession.GetdoctorProfessionAppointmentByID)
